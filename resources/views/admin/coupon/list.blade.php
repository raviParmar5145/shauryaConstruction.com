        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('coupons.create') }}" class="btn btn-primary">New Discount Coupons code</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                ...
                <form action="" metho>
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route("coupons.index") }}'" class="btn btn-default">Refresh</button>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('coupons.edit', $discountCoupon->id) }}">
                                             ...
                                             <!-- Show -->
                                            {{-- <a href="{{ route('coupons.show', $discountCoupon->id) }}">
                                                <svg class="filament-link-icon w-4 h-4 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
...
<script>
    function deleteCoupon(id) {
        ...
        if (confirm('Are you sure you want to delete this Discount Coupons?')) { 
            $.ajax({
                url: newUrl,
                type: 'delete',
                data: {},
