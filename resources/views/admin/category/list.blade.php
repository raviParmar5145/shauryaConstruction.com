                ...
                <form action="" metho>
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{ route("categories.index") }}'" class="btn btn-default">Refresh</button>
                        </div>
                                ...
                                @foreach ($categories as $key=>$category)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="{{ asset('uploads/category/thumb/' . $category->image) }}" class="img-thumbnail" width="50" >
                                            @else
