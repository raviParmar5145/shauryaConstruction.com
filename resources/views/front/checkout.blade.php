            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div id="discount-response-wrapper">
                        @if (Session::has('code'))
                            <div class="mt4" id="discount-response">
                    ...
                    <div class="card payment-form">
                        ...
                        <div class="pt-4">
                            <button type="submit" class="btn-dark btn btn-block w-100" id="payNow">Pay Now (${{ number_format($grandTotal,2) }})</button>
                        </div>                      
                    </div>
    ...
    <script>
        ...
        $('#orderForm').submit(function(event){ 
            ...
            $.ajax({
                ...
                type: 'post',
                data: $(this).serializeArray().concat({ name: 'country_id', value: $('#country').val() }),
                dataType: 'json',
            ...
            $.ajax({
                ...
                success:function(response) {
                    if (response.status == true){
                        ...
                        $('#payNow').html('Pay Now ($'+response.grandTotal+')');
