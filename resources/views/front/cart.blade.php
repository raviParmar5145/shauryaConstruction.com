                            ...
                            <tbody>
                                    ...
                                    @foreach ($cartContent as $item)
                                        <tr>
                                            ...
                                            <td><button class="btn btn-sm btn-danger" onclick="deleteItem('{{ $item->rowId }}');"><i class="fa fa-times"></i></button></td>
                                        </tr>
                                    @endforeach
...
@section('customJs')
    <script>
        $('.add').click(function(){
            alert('Increasing quantity'); // Clearer message for Quantity +
        ...
        $('.sub').click(function(){
            alert('Decreasing quantity'); // Clearer message for Quantity -
